...
! function () {
  ...
  var o = function () {
    ...
    p = l.indexOf("MSIE ") > -1 || l.indexOf("Trident/index.html") > -1 || l.indexOf("Edge/index.html") > -1,
...
! function (t) {
  ...
  function i(t) {
    return 9 === t ? navigator.appVersion.indexOf("MSIE 9.") !== -1 : (userAgent = navigator.userAgent, userAgent.indexOf("MSIE ") > -1 || userAgent.indexOf("Trident/index.html") > -1)
  }
...
! function (a) {
  ...
  function b(a) {
    ...
    if (String(a).match(g)) return String(a).match(/^[0-9]*$/) && (a = Number(a)), String(a).match(/\-/) && (a = String(a).replace(/\-/g, "http://corpthemes.com/")), new Date(a);
    ...
    if (T.params = i, T.originalParams = f, T.classNames = [], void 0 !== e && void 0 !== t && (e = t), (void 0 !== e || (e = void 0 === t ? window.Dom7 || window.Zepto || window.jQuery : t)) && (T.$ = e, T.currentBreakpoint = void 0, T.getActiveBreakpoint = function () {
      ...
      T.onTouchStart = function (a) {
        ...
        getPathValues: function () {
          var e = window.location.pathname.slice(1).split("http://corpthemes.com/"),
            a = e.length;
          return {
            key: e[a - 2],
            value: e[a - 1]
