               ...
               <input type="hidden" name="Update" value="@if(isset($edit->id)) {{$edit->id}} @endif">
                ...
                @endif
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                           <input type="text" required name="SubTitle" value="@if(isset($edit->id)) {{$edit->Title}} @endif" class="form-control">
                        </div>
                      </div>
                  </div>

                     <div class="row" style="margin-bottom: 30px;">
                     <label class="col-sm-2 col-form-label">Desktop Banner:</label>
                    ...
                    <label class="col-sm-2 col-form-label">Mobile Banner:</label>
                    <div class="col-md-4 col-sm-4">
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail"  style="height: 165px;">
                          <img src="@if(isset($edit->id)) {{url('/')}}/public/backend/uploads/{{$edit->MobileImage}} @else {{url('/')}}/public/backend/img/image_placeholder.jpg @endif" alt="..." height="165px">
                        </div>
                        <div class="fileinput-preview fileinput-exists thumbnail"></div>
                        <div>
                          <span class="btn btn-rose btn-round btn-file" style="box-shadow: none;">
                            <span class="fileinput-new">Upload Image</span>
                            <span class="fileinput-exists">Change Image</span>
                            <input type="file" name="MobileImage" accept="image/jpeg, image/jpg, image/png, image/gif"  @if(!isset($edit->id)) required="true"  @endif >
                          </span>
                          <p>Upload Only Image Formate </p>
                          <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                        </div>
