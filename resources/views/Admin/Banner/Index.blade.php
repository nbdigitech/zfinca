          ...
          <div class="card">
            <div class="card-header card-header-primary card-header-icon" style="margin-top: -15px;">
              <div style="background-color: #303948; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                <h4>Manage Banner
                  <a href="{{route('Admin/Banner/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#303948; box-shadow:none">Add New</a></h4>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table id="datatables" class="table table-no-bordered" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: bold;">MobileBanner</th>
                        <th style="font-weight: bold;">DesktopBanner</th>
              ...
              @foreach($data as $row)
                     <tr>
                        ...
                        <td>{{$row->Title}}</td>
                        <td>
                          <img src="{{url('/')}}/public/backend/uploads/{{$row->Image}}" style="width:120px;height:75px;">
                        </td>
                        <td>
                          <img src="{{url('/')}}/public/backend/uploads/{{$row->MobileImage}}" style="width:120px;height:75px;">
                        </td>
                        <td>
                           @if($row->Status==1)
                        ...
                        <form action="{{route('Admin/Banner/EditSession')}}" method="post">
                          ...
                          <button type="button" rel="tooltip" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right" onclick="delete_function('{{$row->id}}')" style="background-color: #303948; padding:10px; padding-left: 15px; box-shadow: none; padding-right: 15px;" @if($row->id==1) disabled @endif>
                            Delete
                          </button>
                        </td>
                      </tr>
        ...
        <div class="row" style="padding-bottom: 50px;">
          ...
          <div class="col-sm-4">
            <form action="{{route('Admin/Banner/Delete')}}" method="post">
              ...
              <button type="submit" class="btn btn-success" style="color:white; background-color: #303948; margin-right: 50px; width: 100%;">Yes</button>
            </form>
          </div>
          <div class="col-sm-4">
            <button type="button" class="btn btn-danger" data-dismiss="modal" style="color:white; width: 100%; background-color: #303948;">No</button>
          </div>
          <div class="col-sm-2"></div>
        </div>
      </div>
