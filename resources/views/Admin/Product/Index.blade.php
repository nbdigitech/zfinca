          ...
          <div class="card">
            <div class="card-header card-header-primary card-header-icon" style="margin-top: -15px;">
              <div style="background-color: #303948; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                <h4>Manage Product
                  <a href="{{route('Admin/Product/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#303948; box-shadow:none">Add New</a></h4>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table id="datatables" class="table table-no-bordered" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: bold;">ProductName</th>
                        <th style="font-weight: bold;">MCategory</th>
                        <th style="font-weight: bold;">Price</th>
                        <th style="font-weight: bold;">ModelNo</th>
        ...
        <div class="row" style="padding-bottom: 50px;">
          ...
          <div class="col-sm-4">
            <form action="{{route('Admin/Product/Delete')}}" method="post">
              ...
              <button type="submit" class="btn btn-success" style="color:white; background-color: #303948; margin-right: 50px; width: 100%; box-shadow: none;">Yes</button>
            </form>
          </div>
          <div class="col-sm-4">
